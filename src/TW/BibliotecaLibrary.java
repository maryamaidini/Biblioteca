...
public class BibliotecaLibrary {
    ...
    */
    ...
    private static void BookReservation(Library Lib,BufferedReader reader) {
        ...
        {
            System.out.println("\n");
            ReservationStatus result =Lib.UpdateBookStatus(BookId,BookStatus.Reserved) ;
            if(result == ReservationStatus.Successful)
    ...
    public static Library CreateLibrary(Library Lib)
    {
        ...
        Books Book1=new Books("Math",1, BookStatus.Available) ;
        Books Book2=new Books("History",2, BookStatus.OutOfStock) ;
        Books Book3=new Books("Science",3, BookStatus.Reserved) ;
